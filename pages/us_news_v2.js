...
export default function Home() {
  ...
  return (
    <div key = "2">
      <div style={{position: "absolute", left: "383px", top:  "915px", width: "1516px", height: "120px", zIndex: "450", overflow: "hidden"}} key = "23">
        <div style={{position: "absolute", left: "79px", top:  "0px", width: "1358px", height: "120px", zIndex: "450"}} key = "24">
        {news.map((property, index) => (
          <div style={{position: "absolute", left: property.left + "px", top:  "0px", width: "320px", height: "120px", zIndex: "450", opacity: property.opacity, transition: "left 2.5s, right 2.5s", overflow: "hidden"}} key = {`news-${index}`}>
            <div style = {{position: "absolute",zIndex: "452" , left: "0px", bottom: "0px", width: "320px", background: "linear-gradient(to top, rgb(0,0,0,0.8) -20%, rgb(0,0,0,0.8) 10%, rgb(0,0,0,0.6) 85%, rgb(0,0,0,0) 100%)", textAlign: "center", padding: "3px 3px 3px"}}>
              <span style = {{fontFamily: "Open Sans", fontWeight: "500"}}>{property.title}</span>
            </div>
            <img src={property.enclosure} style={{position:"absolute", top:"-34px", left: "-8px", width: "336px", height: "189px", zIndex: "451" }}/>
